/**
 * Name:    EXT005MI_GetEXTPTR
 * Description:
 *          API to get data from EXTPTR table
 *
 * Usage:
 *  Arguments
 ...
 *
 */
public class GetEXTPTR extends ExtendM3Transaction {
  ...
  public GetEXTPTR(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi;
  ...
  public void main() {
    ...
    if(!query.read(container)){
      ...
      mi.outData.put("OPNO",container.get("EXOPNO").toString());
      mi.outData.put("TRDT",container.get("EXTRDT").toString());
      mi.outData.put("TRTM",container.get("EXTRTM").toString());
      mi.outData.put("TMSX",container.get("EXTMSX").toString());
      mi.outData.put("GRWT",container.get("EXGRWT").toString());
      mi.outData.put("TAWT",container.get("EXTAWT").toString());
